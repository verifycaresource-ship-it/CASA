    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Administrator'), ('agent', 'Agent'), ('policyholder', 'Policyholder'), ('claim_officer', 'Claim Officer'), ('finance_officer', 'Finance Officer'), ('report_officer', 'Report Officer'), ('hospital', 'Hospital')], default='policyholder', max_length=20)),
                ...
                ('daamiin', models.CharField(blank=True, max_length=150, null=True)),
